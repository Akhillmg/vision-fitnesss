    ...
    return (
        <div className="p-4 pt-8 bg-black min-h-screen text-white space-y-6">
            <div className="flex items-center justify-between">
                <h1 className="text-2xl font-bold uppercase tracking-tighter text-white">Billing & Payments</h1>
            ...
            <Card className="bg-zinc-900 border-zinc-800">
                <CardContent className="p-6">
                    <p className="text-zinc-500 text-center">Payment history and invoices will appear here.</p>
                </CardContent>
            </Card>
        </div>
    )
